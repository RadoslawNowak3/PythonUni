...
min_distance(self, spt, key) - metoda pomocnicza wykorzystywana w algorytmie Dijkstry, znajduje wierzchołek o najmniejszej odległości który nie został jeszcze wykorzystany
